...
const RULES: MissingRule[] = [
  // ════════ 文件类规则 ════════
  {
    ...
    severity: 'high',
    whoShouldFix: 'sales',
    isMissing: ctx => !ctx.hasFile('customer_po') && !ctx.isStepDone('po_confirmed'),
  ...
  },
  {
    ...
    severity: 'high',
    whoShouldFix: 'sales',
    isMissing: ctx => !ctx.hasFile('internal_quote') && !ctx.isStepDone('finance_approval'),
  ...
  },
  {
    ...
    severity: 'high',
    whoShouldFix: 'sales',
    isMissing: ctx => !ctx.hasFile('customer_quote') && !ctx.isStepDone('finance_approval'),
