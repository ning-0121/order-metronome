...
import { getProcurementCostSummary, getBudgetVsActual } from '@/app/actions/procurement-cost';
...
export default async function ProcurementCostDetailPage({ params }: { params: Promise<{ orderId: string }> }) {
  ...
  const bva = error ? null : (await getBudgetVsActual(orderId)).data;
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      {error ? (
        ...
        <div className="space-y-4">
          {bva && <BudgetVsActualTable data={bva} />}
