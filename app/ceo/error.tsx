...
export default function CEOError({
  ...
  useEffect(() => {
    console.error('[CEOPage Error]', error?.message, error?.digest);
  }, [error]);

  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center max-w-lg px-6">
        <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-2xl bg-amber-50">
          <span className="text-3xl">🎯</span>
        </div>
        <h1 className="text-xl font-bold text-gray-900 mb-2">节拍页面加载失败</h1>
