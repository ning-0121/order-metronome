...
export const MILESTONE_TEMPLATE_V1: Array<{
  ...
  // Ship Sample Gates (before booking)
  { step_key: "ship_sample_sent", name: "船样寄出", owner_role: "sales", is_critical: true, evidence_required: true },
  { step_key: "ship_sample_approved", name: "客户确认船样", owner_role: "sales", is_critical: true, evidence_required: true },
