...
export const SOP_MAP: Record<string, SOPConfig> = {
  ...
  po_confirmed: {
    // 2026-07-10 用户拍板:PO确认免上传凭证,靠 财务+生产部 多方确认完成(不再要三份文件/三单比对)
    sop_title: 'PO确认 SOP',
    sop_steps: [
      '1. 核对客户PO关键信息：款号、数量、尺码配比、颜色、交期是否一致',
      '2. 确认贸易条款（FOB/DDP）、付款方式',
      '3. 检查并标注特殊要求（浅色、撞色、大码、复杂印花等风险标签）',
      '4. 完成检查清单必填项',
      '5. 财务 + 生产部 多方确认 → 节点自动完成（免上传凭证）',
    ],
    required_fields: [],
    completion_rules: ['关键信息核对一致', '财务 + 生产部 已确认', '检查清单必填项已完成'],
  },
